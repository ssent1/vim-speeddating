...
if !exists("g:speeddating_no_mappings") || !g:speeddating_no_mappings
  ...
  nmap z<C-A> <Plug>SpeedDatingNowUTC
  nmap z<C-X> <Plug>SpeedDatingNowLocal
endif

" original
" z<C-A> ==> Zulu, UTC "mil" time;                    d<C-A>
" z<C-X> ==> local time zone, EDT: -0400, ET: -0500;  d<C-X>
...
SpeedDatingFormat %Y%[/-]%m%1%dT%H%M%S%z          " ISO 8601 date & time in UTC
SpeedDatingFormat %Y%[/-]%m%1%d                   " ISO 8601 date
